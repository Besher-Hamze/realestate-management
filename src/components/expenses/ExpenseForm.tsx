...
const initialExpenseData: Partial<ExpenseFormData> = {
    ...
    amount: 0,
    expenseDate: new Date().toISOString().split('T')[0], // Keep as string
    notes: '',
};
...
export default function ExpenseForm({
    ...
    const onSubmit = async (data: ExpenseFormData) => {
        try {
            ...
            const formattedData = {
                ...data,
                expenseDate: data.expenseDate, // Already in YYYY-MM-DD format from input
            };

            console.log('Submitting expense data:', formattedData); // Debug log
    ...
    // Format current date for input max attribute
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="space-y-6">
                    ...
                    <FormInput
                        ...
                        required
                        helpText="تاريخ تنفيذ المصروف (بصيغة YYYY-MM-DD)"
                    />
                </div>
                ...
                {process.env.NODE_ENV === 'development' && (
                    <div className="bg-gray-50 border border-gray-200 rounded-md p-4">
                        ...
                        <div className="text-xs text-gray-600">
                            <p>تاريخ المصروف سيتم إرساله بصيغة: YYYY-MM-DD</p>
                            <p>مثال: {getCurrentDate()}</p>
                        </div>
                    </div>
                )}
