      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold text-primary-600">Real Estate Manager</h1>
          </div>
          
          <div className="flex items-center space-x-4">
            {!isAuthenticated && !isLoading && (
              <Link href="/login">
                <Button variant="primary" className="px-6">Log In</Button>
              </Link>
            )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl">
                A complete solution for property owners and tenants to manage
                real estate properties, reservations, and service requests.
              </p>
                  ...
                  <div className="rounded-lg overflow-hidden shadow-inner bg-white p-4">
                    <div className="flex justify-between items-center mb-6 pb-4 border-b">
                      <div className="flex items-center">
                        ...
                        <h3 className="ml-3 font-semibold text-gray-800">Property Dashboard</h3>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-green-50 p-3 rounded border border-green-100">
                          <div className="text-sm text-green-700 font-medium">Rented</div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center text-sm">
                            ...
                            <span className="text-gray-700">New payment received</span>
                            <span className="ml-auto text-gray-500 text-xs">2h ago</span>
                          </div>
                          <div className="flex items-center text-sm">
                            <div className="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
                            <span className="text-gray-700">Rented request</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mt-6">
              Our platform offers a wide range of features for both property owners and tenants.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                Easily manage buildings, units, and tenants in one centralized platform with detailed tracking and reporting.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Reservation System</h3>
              <p className="text-gray-600 mb-4">
                Create and manage property reservations with detailed tracking, contract storage, and payment integration.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-gray-700">
                  <svg className="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Service Requests</h3>
              <p className="text-gray-600 mb-4">
                Submit and track maintenance requests and service orders efficiently with real-time updates.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-gray-700">
                  <svg className="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              ...
              <div className="text-xl text-gray-700">Properties Managed</div>
            </div>
            <div className="p-6">
              <div className="text-4xl font-bold text-primary-600 mb-2">2,000+</div>
              <div className="text-xl text-gray-700">Happy Tenants</div>
            </div>
            <div className="p-6">
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-primary-100">
            Join thousands of property managers and tenants already using our platform.
          </p>
          <Link href="/login">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold">Real Estate Manager</h3>
              </div>
              <p className="text-gray-400">
                Simplifying property management for owners and tenants with our comprehensive platform.
              </p>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 text-primary-200">Contact</h3>
              <ul className="space-y-3 text-gray-400">
                ...
                <li className="flex items-start">
                  ...
                  <span>123 Property St, Real Estate City, 10001</span>
                </li>
              </ul>
            </div>
          </div>
